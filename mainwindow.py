...
from instrumentcontrollerwidget import InstrumentControllerWidget
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self._instrumentControllerWidget = InstrumentControllerWidget(parent=self, controller=self._instrumentController)
